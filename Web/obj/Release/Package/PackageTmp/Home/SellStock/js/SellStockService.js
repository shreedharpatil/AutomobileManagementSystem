...
var SellStockServiceViewModel = (function () {
    var model = function (http, rootScope, warningMessageService, captureImageService) {
        ...
        self.CalculateGoodTotalAmount = function (good) {
            ...
            good.TotalAmount = unitprice * quantity;
            self.CalculateTotalTransactionAmount();
        };
        ...
        self.CalculateTotalTransactionAmount = function () {
            ...
            _.each(self.Goods, function (good) {
                self.CustomerTransaction.TotalAmount += isNaN(good.TotalAmount) ? 0 : parseFloat(good.TotalAmount);
            });
            self.DeductVatAmount();
            self.DeductDiscountAmount();
            self.DeductPaidAmount();
        };
        ...
        self.DeductPaidAmount = function () {
            ...
            var total = isNaN(self.CustomerTransaction.GrandTotalAmount) ? 0 : parseFloat(self.CustomerTransaction.GrandTotalAmount);
            self.CustomerTransaction.DueAmount = total - paid;
        };
        ...
        self.DeductVatAmount = function () {
            ...
            self.CustomerTransaction.GrandTotalAmount = totalAmount + vatAmount;
        ...
        self.CalculateDueAmount = function () {
            ...
            var paid = isNaN(self.CustomerTransaction.PaidAmount) ? 0 : parseFloat(self.CustomerTransaction.PaidAmount);
            self.CustomerTransaction.DueAmount = grandTotal - paid;
        };
        ...
        self.DeductDiscountAmount = function () {
            ...
            self.CustomerTransaction.GrandTotalAmount = totalAmount - discountAmount;
            self.CalculateDueAmount();
        };
        ...
        self.RemoveGood = function (good) {
            ...
            var goodtotal = isNaN(good.TotalAmount) ? 0 : parseFloat(good.TotalAmount);
            var total = isNaN(self.CustomerTransaction.TotalAmount) ? 0 : parseFloat(self.CustomerTransaction.TotalAmount);
            self.CustomerTransaction.TotalAmount = total - goodtotal;
            self.DeductVatAmount();
            self.DeductDiscountAmount();
            var paid = isNaN(self.CustomerTransaction.PaidAmount) ? 0 : parseFloat(self.CustomerTransaction.PaidAmount);
            var grandTotal = isNaN(self.CustomerTransaction.GrandTotalAmount) ? 0 : parseFloat(self.CustomerTransaction.GrandTotalAmount);
